...
<section class="kitchen-previous-orders min-vh-100 d-flex align-items-center mt-lg-0 mt-3">
    ...
    <h2 class="mt-5 mb-4" style="font-size: 1.0rem;font-style: italic;">Catering Services</h2>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('[id^="servicetatus"]').forEach(function (selectElement) {
            selectElement.addEventListener('change', function () {
                const packageId = selectElement.id.replace('servicetatus', '');
